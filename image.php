	...
	if($_REQUEST["searchText"]!='')
	{
		...
		if (is_array($jsonobj->value) || is_object($jsonobj->value))
		{
			...
			foreach($jsonobj->value as $value)
    		{
        		...
        		$data .= '<div class=\'image\' rank="rank' . $i . '"><a class="image" title="' . $value->name . '" href="www.' . $value->hostPageDisplayUrl . '" vertical="Image" style="background-image: url(' . $value->thumbnailUrl . ');">';
